...
<div class="box box-primary" id="formEventBook">
  <div class="box-header with-border">
    <h3 class="box-title"><b>Rendez-vous</b></h3>
  </div>
  <!-- /.box-header -->
  <!-- form start -->
    ...
    <div class="box-body">
      ...
      <div class="row">
      	<div class="col-xs-6">
        	...
        	<input type="text" id="rdate" class="form-control" placeholder="YYYY-mm-dd" disabled>
        	<input type="hidden" name="rdate" id="rdate1" class="form-control" placeholder="YYYY-mm-dd">
        ...
        <div class="col-xs-6">
            ...
            <input type="time" name="rtime" id="rtime" class="form-control" placeholder="HH:mm">
